...
* `-timer`: This is a waiting timer for a required `reliable_[%d]_{%d}.pgm` and `flow_[%02d]_{%02d}.flo` files to be created, when optical flow is computed in background
